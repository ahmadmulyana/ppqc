    ...
    <div class="wrapper dashboard-page">
        <div class="page-title">
            <h5 class="fw-bolder">Assessment Pekerjaan</h5>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb subtitle">
                  <li class="breadcrumb-item"><a href="#">PP QHSE</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Assessment Pekerjaan</li>
                </ol>
                <?= tgl_indo(date('Y-m-d')); ?>
              </nav>
        </div>
                            ...
                            <table id="exampletype" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    -->
                                        ...
                                        <td class="text-center"><a href="<?= site_url('assesment/assesment_detail/'.$r->id);?>"><span class="material-icons-round text-success">edit</span></a> </td>
                                    </tr>
                                    <?php $no++; } ?>
