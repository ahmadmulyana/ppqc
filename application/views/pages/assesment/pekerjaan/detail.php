<style type="text/css">
    ...
    <div class="wrapper dashboard-page">
        <div class="page-title">
            <h5 class="fw-bolder">Assessment</h5>
                                    ...
                                    <table class="table table-striped" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($assesment as $a) : 
                                                ...
                                                ?>
                                            <tr>
                                                <td class="fw-bolder"><?= $a->nama_pekerjaan?></td>
                                                <td ><?= $a->sum_nilai_pekerjaan?></td>
                                                <td ><?= round(($a->sum_koreksi/$a->jumlah),2)?>%</td>
                                                <td class="text-center"><a href="<?= site_url('assesment_edit/'.$a->pekerjaan_id);?>"><span class="material-icons-round text-success">edit</span></a><a href="<?= site_url('assesment/hapus/'.$a->id);?>"><span class="material-icons-round text-danger ms-3">delete</span></a>
                                            ...
                                            <?php
                                                $hasil = $this->db->get_where('tr_assesment_pekerjaan', array('pekerjaan_id'=>$a->pekerjaan_id))->result();
                                                        ...
                                                        <td class="hiddenRow" colspan="5">
                                                            <div id="tampil<?= $a->id?>" class="collapse">
                                                                <table class="table-striped" style="width:100%;" >
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                        <td style="padding-left: 20px;" width="50%"><?= $data->nama_vendor; ?></td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-primary fw-bolder"><?= round(($prosentase_total/$jml_data),2); ?>%</td>
                                                <td></td>
                                            </tr>
                                        </tfoot>
                                    </table>
        ...
        <div class="modal fade" id="frm_assesment" tabindex="-1" role="dialog" aria-labelledby="centerModalLabel">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <form name="f_assesment_s" id="f_assesment_s" onsubmit="return assesment_s();">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select id="nama_pekerjaan" name="nama_pekerjaan" class="form-control">
                                ...
                                <select name="nama_vendor" class="form-control" >
                                    <option value="" selected>--Pilih--</option>
                                     <?php foreach ($vendor as $r) { ?>
                                        <option value="<?= $r->id?>"><?= $r->nama_vendor ?></option>    
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label>Satuan</label>
                                <input id="satuan_pekerjaan" name="satuan_pekerjaan" type="text" class="form-control" readonly>
                            </div>
                        </div>

                        <div class="row">
                            <div class="form-group col-md-12">
                                <label>Parameter Pekerjaan</label>
                                <input name="parameter_pekerjaan" type="text" class="form-control">
                            </div>
                        </div>
