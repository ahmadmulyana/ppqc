...
.syletext{
    ...
    <div class="wrapper dashboard-page">
        ...
        <input type="hidden" name="mode" id="mode" value="tr_assesment_material">
                            ...
                            <table class="table table-striped" style="width:100%" >
                                ...
                                <tbody>
                                    <?php $no=1; foreach ($pekerjaan as $d) { 
                                        ...
                                        <td width="50%"><?= $d->nama_supplier; ?></td>
                                        <td width="10%"><?= $d->satuan_pekerjaan; ?></td>
                                        <td width="10%"><input type="text" class="form-control syletext" value="<?= $d->nilai_pekerjaan; ?>" readonly></td>
