    ...
    <div class="wrapper qsia-page">
        <div class="page-title">
            <h5 class="fw-bolder">Master Mandor</h5>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb subtitle">
                  <li class="breadcrumb-item"><a href="#">PP QHSE</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Master Mandor</li>
                </ol>
                <?=  tgl_indo(date('Y-m-d')); ?>
              </nav>
        </div>
        ...
        <div class="content-wrapper">
            <div class="row gap-m-2">
                <div class="col-md-12 mb-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row w-100">
                                <div class="col-md-6"><span class="subtitle fw-bolder">List Mandor</span></div>
                                <div class="col-md-6 text-right">
                                    <a onclick="return m_mandor_e(0);" style="cursor: pointer;" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah </a>
                                    <!-- Modal -->
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a style="cursor: pointer;" onclick="return m_mandor_e(<?= $r->id ?>);"><span class="material-icons-round text-success">edit</span></a> 
                                                <a href="#" onclick="return m_mandor_h(<?= $r->id ?>);" ><span class="material-icons-round text-danger">delete</span></a> 
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                ...
                <div class="modal fade" id="mandor" tabindex="-1" role="dialog" aria-labelledby="centerModalLabel">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <?=form_open('master/mandor_simpan', array('method'=>'post'));?>
