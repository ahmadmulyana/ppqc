                        ...
                        <div class="card-header">
                            <div class="row w-100">
                                ...
                                <div class="col-md-6 text-right">
                                    <a onclick="return m_type_nc_e(0);" style="cursor: pointer;" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Level NC</a>
                                    <!-- Modal -->
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $typenc->level_nc;?></td>
                                            <td class="text-center">
                                                <a style="cursor: pointer;" onclick="return m_level_nc_e(<?= $typenc->id ?>);"><span class="material-icons-round text-success">edit</span></a> 
                                                <a href="#" onclick="return m_level_nc_h(<?= $typenc->id ?>);" ><span class="material-icons-round text-danger">delete</span></a> 
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                ...
                <div class="modal fade" id="m_type_nc" tabindex="-1" role="dialog" aria-labelledby="centerModalLabel">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form name="f_type_nc" id="f_type_nc" onsubmit="return m_level_nc_s();">
                                ...
                                <div class="modal-body text-left">
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>Nama</label>
                                            <input id="level_nc" name="level_nc" type="text" class="form-control" value="">
                                        </div>
                                    </div>
                                </div>
