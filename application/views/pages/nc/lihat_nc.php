...
<script src="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.8.2/js/lightbox-plus-jquery.min.js"></script>
    ...
    <div class="wrapper css-page">
        <div class="page-title">
            <h5 class="fw-bolder"><a href="<?= site_url('nc_user');?>"><i class="fas fa-chevron-left mr-3"></i></a> Laporan NC</h5>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <span class="subtitle fw-bolder">Lihat NC</span>
                        </div>
                        <div class="card-body">
                            <div id="smartwizard">
                                <ul class="nav">
                                    ...
                                    <div id="step-1" class="tab-pane" role="tabpanel">
                                        ...
                                        <div class="card-body overflow-auto p-4">
                                            ...
                                            foreach ($photo_temuan as $key => $p) { ?>
                                                ...
                                                <a href="<?= base_url('uploads/nc/'.$p->file); ?>" data-lightbox="homePortfolio" title="">
                                                    <img src="<?= base_url('uploads/nc/'.$p->file); ?>"/>
                                                </a>
                                                <div class="setimgisi" style="margin-right: 10px;">
                                                    <a href="<?= base_url('uploads/nc/'.$p->file); ?>" role="button" class="text text-success" download=""><span class="material-icons-round">download</span></a>
                                                </div>
                                                </div>
                                    ...
                                    <div id="step-2" class="tab-pane" role="tabpanel">
                                        <div class="container-fluid mb-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Level</label>
                                                    <select name="level_nc" class="form-control" readonly>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label>Type</label>
                                                    <select name="type_nc" class="form-control" readonly>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input name="referensi" type="text" class="form-control" value="<?= $data->referensi; ?>" readonly> 
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <label>Uraian Hasil Investigasi</label>
                                                    <textarea name="uraian_investigasi" class="form-control" rows="4" readonly><?= $data->uraian_investigasi; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body overflow-auto p-4">
                                            <div class="row mb-2">
                                            <?php
                                            foreach ($photo_investigasi as $key => $p) { ?>
                                        ...
                                        <div class="container-fluid mb-2">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    <label>Bahan</label>
                                                    <select name="bahan" class="form-control" readonly>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label>Orang</label>
                                                    <select name="orang" class="form-control" readonly>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label>Cara</label>
                                                    <select name="cara" class="form-control" readonly>
                                                        <option>-</option>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label>Alat</label>
                                                    <select name="alat" class="form-control" readonly>
                                                        <option>Mencukupi</option>
                                                        <option>-</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="lingkungan" class="form-control" readonly>
                                        ...
                                        <div class="container-fluid mb-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="disposisi_pm" class="form-control" readonly>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" name="tanggal_rencana" value="<?= $data->tanggal_rencana; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <label>Uraian Tidak Lanjut</label>
                                                    <textarea name="uraian_tindak_lanjut" class="form-control" rows="4" readonly><?= $data->uraian_tindak_lanjut; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="step-4" class="tab-pane" role="tabpanel" style="overflow: auto;">
                                        <div class="container-fluid mb-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Status</label>
                                                    <select name="status_nc" class="form-control" readonly>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input name="tanggal_closing" type="date" class="form-control" value="<?= $data->tanggal_closing; ?>" readonly>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Realisasi Biaya</label>
                                                    <input name="realisasi_biaya" type="number" class="form-control" value="<?= $data->realisasi_biaya; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body overflow-auto p-4">
                                            <div class="row mb-2">
                                            <?php
                                            foreach ($photo_realisasi as $key => $p) { ?>
